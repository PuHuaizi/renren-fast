...
import io.renren.common.validator.group.BaiduGroup;
...
public class CloudStorageConfig implements Serializable {
    ...
    //百度云绑定的域名
    @NotBlank(message = "百度云绑定的域名不能为空", groups = BaiduGroup.class)
    @URL(message = "百度云绑定的域名格式不正确", groups = BaiduGroup.class)
    private String baiduDomain;
    //百度云路径前缀
    private String baiduPrefix;
    //百度云EndPoint
    @NotNull(message = "百度云EndPoint不能为空", groups = BaiduGroup.class)
    private String baiduEndPoint;
    //百度云AccessKeyID
    @NotBlank(message = "百度云AccessKeyID不能为空", groups = BaiduGroup.class)
    private String baiduAccessKeyID;
    //百度云SecretAccessKey
    @NotBlank(message = "百度云SecretAccessKey不能为空", groups = BaiduGroup.class)
    private String baiduSecretAccessKey;
    //百度云BucketName
    @NotBlank(message = "百度云BucketName不能为空", groups = BaiduGroup.class)
    private String baiduBucketName;
    //百度云BOS所属地区
    @NotBlank(message = "所属地区不能为空", groups = BaiduGroup.class)
    private String baiduRegion;
    ...
    public String getBaiduAccessKeyID() {
        return baiduAccessKeyID;
    }

    public void setBaiduAccessKeyID(String baiduAccessKeyID) {
        this.baiduAccessKeyID = baiduAccessKeyID;
    }

    public String getBaiduSecretAccessKey() {
        return baiduSecretAccessKey;
    }

    public void setBaiduSecretAccessKey(String baiduSecretAccessKey) {
        this.baiduSecretAccessKey = baiduSecretAccessKey;
    }

    public String getBaiduBucketName() {
        return baiduBucketName;
    }

    public void setBaiduBucketName(String baiduBucketName) {
        this.baiduBucketName = baiduBucketName;
    }

    public String getBaiduRegion() {
        return baiduRegion;
    }

    public void setBaiduRegion(String baiduRegion) {
